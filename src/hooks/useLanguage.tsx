...
const translations: Translations = {
  ...
  'profile.bioPlaceholder': { ar: 'وصف مختصر عن مشروعك أو خدماتك...', en: 'A brief description of your project or services...' },
  ...
  'items.addItems': { ar: 'أضف منتجاتك أو خدماتك مع صورها', en: 'Add your products or services with images' },
  'items.addItem': { ar: 'إضافة عنصر', en: 'Add Item' },
  'items.editItem': { ar: 'تعديل العنصر', en: 'Edit Item' },
  'items.addNewItem': { ar: 'إضافة عنصر جديد', en: 'Add New Item' },
  'items.productImage': { ar: 'صورة المنتج', en: 'Product Image' },
  ...
  'items.titlePlaceholder': { ar: 'اسم المنتج أو الخدمة', en: 'Product or service name' },
  ...
  'items.loadError': { ar: 'فشل في تحميل العناصر', en: 'Failed to load items' },
  'items.updateError': { ar: 'فشل في تحديث العنصر', en: 'Failed to update item' },
  'items.updated': { ar: 'تم التحديث', en: 'Updated' },
  'items.itemUpdated': { ar: 'تم تحديث العنصر بنجاح', en: 'Item updated successfully' },
  'items.maxReached': { ar: 'تم الوصول للحد الأقصى', en: 'Maximum limit reached' },
  'items.maxItems': { ar: 'لا يمكنك إضافة أكثر من 25 عنصر', en: 'You cannot add more than 25 items' },
  'items.addError': { ar: 'فشل في إضافة العنصر', en: 'Failed to add item' },
  'items.added': { ar: 'تمت الإضافة', en: 'Added' },
  'items.itemAdded': { ar: 'تم إضافة العنصر بنجاح', en: 'Item added successfully' },
  ...
  'orders.ordersAppear': { ar: 'ستظهر الطلبات هنا عندما يطلب العملاء منتجاتك', en: 'Orders will appear here when customers order your products' },
  ...
  'orders.products': { ar: 'المنتجات', en: 'Products' },
  ...
  // AI Guide
  'aiGuide.title': { ar: 'مرشد المنصة', en: 'Platform Guide' },
  'aiGuide.online': { ar: 'متصل الآن', en: 'Online now' },
  'aiGuide.welcome': { ar: 'مرحباً! أنا مرشد المنصة الذكي 👋\n\nكيف يمكنني مساعدتك اليوم؟', en: 'Hello! I am the smart platform guide 👋\n\nHow can I help you today?' },
  ...
  'aiGuide.q1': { ar: 'كيف أنشئ صفحة عرض؟', en: 'How to create a display page?' },
  'aiGuide.q2': { ar: 'كيف أضيف منتجات؟', en: 'How to add products?' },
